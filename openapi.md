...
|Name|In|Type|Required|Description|
|---|---|---|---|---|
|body|body|[postVer1BotsCreateBot](#schemapostver1botscreatebot)|true|none|
...
"stop_loss[timeout][enabled]": true
...
|» take_profit[steps][][price][value]|body|[string]|false|only if position has no trailing or position trailing is finished|
|» take_profit[steps][][price][percent]|body|[string]|false|only if position has trailing and position trailing is not finished|
|» take_profit[steps][][trailing][enabled]|body|[string]|true|none|
|» take_profit[steps][][trailing][percent]|body|[string]|true|none|
...
|» take_profit[steps][][price][value]|body|[string]|false|none|
|» take_profit[steps][][price][percent]|body|[string]|false|none|
|» take_profit[steps][][trailing][enabled]|body|[string]|true|none|
|» take_profit[steps][][trailing][percent]|body|[string]|true|none|
|» stop_loss[enabled]|body|boolean|true|none|
|» stop_loss[breakeven]|body|boolean|false|none|
...
<h2 id="tocS_postVer1BotsCreateBot">postVer1BotsCreateBot</h2>
<!-- backwards compatibility -->
<a id="schemapostver1botscreatebot"></a>
<a id="schema_postVer1BotsCreateBot"></a>
<a id="tocSpostver1botscreatebot"></a>
<a id="tocspostver1botscreatebot"></a>
...
|account_id|integer(int32)|true|none|id from GET /ver1/accounts|
|pairs|[string]|true|none|Pass single pair to create SingleBot or any other number of pairs to create MultiBot|
|max_active_deals|integer(int32)|false|none|none|
|base_order_volume|number(double)|true|none|Base order size|
|base_order_volume_type|string|false|none|base order volume currency|
|take_profit|number(double)|true|none|Target profit(percentage)|
|safety_order_volume|number(double)|true|none|Safety trade size|
|safety_order_volume_type|string|false|none|safety order volume currency|
|martingale_volume_coefficient|number(double)|true|none|none|
|martingale_step_coefficient|number(double)|true|none|none|
|max_safety_orders|integer(int32)|true|none|Max safety trades count|
|active_safety_orders_count|integer(int32)|true|none|Max active safety trades count|
|stop_loss_percentage|number(double)|false|none|none|
|cooldown|number(double)|false|none|none|
|trailing_enabled|boolean|false|none|Enable trailing take profit. Binance only.|
|trailing_deviation|number(double)|false|none|required if trailing_enabled|
|btc_price_limit|number(double)|false|none|none|
|strategy|string|false|none|none|
|safety_order_step_percentage|number(double)|true|none|Price deviation to open safety trades(percentage)|
|take_profit_type|string|true|none|Percentage: base – from base order, total – from total volume|
|strategy_list|[json]|true|none|For manual signals: [{"strategy":"manual"}] or []<br><br>                                                        For non-stop(1 pair only): [{"strategy":"nonstop"}]<br><br>                                                        QFL: {"options": {"type": "original"}, {"percent": 3}, "strategy": "qfl"}] <br><br>                                                        TradingView: [{"options": {"time": "5m", "type": "buy_or_strong_buy"}, "strategy": "trading_view"}|
|leverage_type|string|false|none|Used for Bitmex bots only|
|leverage_custom_value|number(double)|false|none|required if leverage_type is isolated|
|min_price|number(double)|false|none|minimum price to open deal|
|max_price|number(double)|false|none|maximum price to open deal|
|stop_loss_timeout_enabled|boolean|false|none|none|
|stop_loss_timeout_in_seconds|integer(int32)|false|none|StopLoss timeout in seconds if StopLoss timeout enabled|
|min_volume_btc_24h|number(double)|false|none|none|
|tsl_enabled|boolean|false|none|Enable trailing stop loss. Bitmex only.|
|deal_start_delay_seconds|integer(int32)|false|none|Deal start delay in seconds|
|profit_currency|string|false|none|Take profit currency|
|start_order_type|string|false|none|none|
|stop_loss_type|string|false|none|none|
|disable_after_deals_count|integer(int32)|false|none|Bot will be disabled after opening this number of deals|
|allowed_deals_on_same_pair|integer(int32)|false|none|Allow specific number of deals on the same pair. Multibot only.|
|close_deals_timeout|integer(int32)|false|none|Close bot deals after given number of seconds. Must be greater than 60.|
...
<h2 id="tocS_IndexEntity">IndexEntity</h2>
<!-- backwards compatibility -->
<a id="schemaindexentity"></a>
<a id="schema_IndexEntity"></a>
<a id="tocSindexentity"></a>
<a id="tocsindexentity"></a>
...
|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|bots|[[MarketplaceBotEntity](#schemamarketplacebotentity)]|false|none|none|
|total|integer(int32)|false|none|none|
|page|integer(int32)|false|none|none|

<h2 id="tocS_MarketplaceBotEntity">MarketplaceBotEntity</h2>
<!-- backwards compatibility -->
<a id="schemamarketplacebotentity"></a>
<a id="schema_MarketplaceBotEntity"></a>
<a id="tocSmarketplacebotentity"></a>
<a id="tocsmarketplacebotentity"></a>
...
|marketplace_item|[MarketplaceItem](#schemamarketplaceitem)|false|none|none|
|profit|[Profit](#schemaprofit)|false|none|none|
|currencies|[string]|false|none|none|
|copies|integer(int32)|false|none|Bot's copies count|
|is_favorite|boolean|false|none|none|

<h2 id="tocS_MarketplaceItem">MarketplaceItem</h2>
<!-- backwards compatibility -->
<a id="schemamarketplaceitem"></a>
<a id="schema_MarketplaceItem"></a>
<a id="tocSmarketplaceitem"></a>
<a id="tocsmarketplaceitem"></a>
...
<h2 id="tocS_Profit">Profit</h2>
<!-- backwards compatibility -->
<a id="schemaprofit"></a>
<a id="schema_Profit"></a>
<a id="tocSprofit"></a>
<a id="tocsprofit"></a>
